---
title: Understanding contraceptive use
jupyter: python3
---
...
While the `StandardChoice` module will be appropriate for most analyses, we have also included two simpler versions, `SimpleChoice` and `RandomChoice`. 
